...
{
	/// <summary>
	/// Chained base controller.
	/// </summary>
	/// <typeparam name="TEntity"></typeparam>
	/// <typeparam name="TLogic"></typeparam>
	/// <typeparam name="TKey"></typeparam>
	/// <typeparam name="TEnum"></typeparam>
	public abstract class ChainOfRespController<TEntity, TLogic, TKey, TEnum> : ApplicationController<TEntity, TLogic, TKey>
		where TEntity : IBaseEntity<TKey>
		where TLogic : IBaseChainOfRespLogic<TEntity, TKey, TEnum>
		where TKey : struct
		where TEnum : Enum
	{
		/// <summary>
		...
		public ChainOfRespController(IConfiguration configuration, IHttpContextAccessor accessor, TLogic baseLogic, TEnum controllerEnum, bool ThrowUserData = true) :
