...
namespace OpenAccount.Repository.Migrations
{
    ...
    [Migration("20230722044337_signerLog")]
    partial class signerLog
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OpenAccount.Entities.Accounts.AccountTypeSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            SysDate = new DateTime(2023, 7, 22, 8, 13, 37, 74, DateTimeKind.Local).AddTicks(3162)
                        },
                        new
                        {
                            Id = (short)2,
                            ...
                            MinBalance = 330000L,
                            OpenAccountPrice = 40000L,
                            SysDate = new DateTime(2023, 7, 22, 8, 13, 37, 74, DateTimeKind.Local).AddTicks(3195)
                        });
                });
            ...
            modelBuilder.Entity("OpenAccount.Entities.Requests.RequestCommitmentLetter", b =>
                {
                    ...
                    b.Property<string>("FileNameInFileManager")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasComment("نام جدید فایلی که سرویس مدیریت فایل ها ایجاد کرده");
            ...
            modelBuilder.Entity("OpenAccount.Entities.Requests.RequestDigitalSignatureLog", b =>
                {
                    ...
                    b.ToTable("RequestDigitalSignatureLog");
                });
