...
namespace OpenAccount.Repository.Migrations
{
    ...
    [Migration("20230711130113_WalletTransferRequest")]
    partial class WalletTransferRequest
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OpenAccount.Entities.Accounts.AccountTypeSetting", b =>
                {
                    ...
                    b.Property<decimal>("CardPrice")
                        ...
                        .HasComment("هزینه کارت");

                    b.Property<decimal>("InqueryPrice")
                        .HasColumnType("decimal(18, 2)")
                        .HasComment("هزینه استعلام");
                    ...
                    b.Property<decimal>("OpenAccountPrice")
                        .HasColumnType("decimal(18, 2)")
                        .HasComment("هزینه افتتاح حساب");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            MinBalance = 1000000m,
                            OpenAccountPrice = 40000m,
                            SysDate = new DateTime(2023, 7, 11, 16, 31, 13, 370, DateTimeKind.Local).AddTicks(7548)
                        },
                        new
                        {
                            Id = (short)2,
                            ...
                            MinBalance = 330000m,
                            OpenAccountPrice = 40000m,
                            SysDate = new DateTime(2023, 7, 11, 16, 31, 13, 370, DateTimeKind.Local).AddTicks(7584)
                        });
                });
            ...
            modelBuilder.Entity("OpenAccount.Entities.Publics.Wallets.WalletTransferRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("WalletDesCharged")
                        .HasColumnType("bit")
                        .HasComment("مبلغ از کیف پول کسر شد");

                    b.HasKey("Id");

                    b.HasIndex("RequestId");

                    b.ToTable("WalletTransferRequest", null, t =>
                        {
                            t.HasComment("برداشت از کیف پول مشتری");
                        });
                });
            ...
            modelBuilder.Entity("OpenAccount.Entities.Requests.RequestCommitmentLetter", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasComment("دریافت تعهدنامه");

                    b.Property<string>("CommitmentLetterError")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasComment("مشکل دریافت تعهدنامه");

                    b.Property<bool>("CommitmentLetterGot")
                        .HasColumnType("bit")
                        .HasComment("تعهدنامه دریافت شد؟");

                    b.Property<string>("FileAddress")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasComment("آدرس فایل دریافت شده");

                    b.Property<DateTime>("SysDate")
                        .HasColumnType("datetime2")
                        .HasComment("تاریخ دریافت فایل");

                    b.HasKey("Id");

                    b.ToTable("RequestCommitmentLetter", (string)null);
                });
            ...
            modelBuilder.Entity("OpenAccount.Entities.Requests.RequestDigitalSignature", b =>
                {
                    ...
                    b.Property<bool>("DigitalSignatureDone")
                        .HasColumnType("bit")
                        .HasComment("امضای دیجیتال اعمال شد؟");

                    b.Property<string>("DigitalSignatureError")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasComment("مشکل امضای دیجیتال");
            ...
            modelBuilder.Entity("OpenAccount.Entities.Requsts.Request", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("OpenAccount.Entities.Accounts.UserAccount", b =>
                {
                    b.HasOne("OpenAccount.Entities.Requsts.Request", "Request")
                        .WithOne("UserAccount")
            ...
            modelBuilder.Entity("OpenAccount.Entities.Publics.Wallets.WalletTransferRequest", b =>
                {
                    b.HasOne("OpenAccount.Entities.Requsts.Request", "Request")
                        .WithMany("WalletTransferRequests")
                        .HasForeignKey("RequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("OpenAccount.Entities.Requests.RequestCommitmentLetter", b =>
                {
                    b.HasOne("OpenAccount.Entities.Requsts.Request", "Request")
                        .WithOne("RequestCommitmentLetter")
                        .HasForeignKey("OpenAccount.Entities.Requests.RequestCommitmentLetter", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("OpenAccount.Entities.Requsts.Request", b =>
                {
                    ...
                    b.Navigation("RequestCommitmentLetter");
                    ...
                    b.Navigation("WalletTransferRequests");
                });
