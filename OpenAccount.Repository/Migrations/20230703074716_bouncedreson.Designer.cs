...
namespace OpenAccount.Repository.Migrations
{
    ...
    [Migration("20230703074716_bouncedreson")]
    partial class bouncedreson
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OpenAccount.Entities.Accounts.AccountTypeSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            SysDate = new DateTime(2023, 7, 3, 11, 17, 16, 99, DateTimeKind.Local).AddTicks(8282)
                        },
                        new
                        {
                            Id = (short)2,
                            ...
                            MinBalance = 330000m,
                            OpenAccountPrice = 40000m,
                            SysDate = new DateTime(2023, 7, 3, 11, 17, 16, 99, DateTimeKind.Local).AddTicks(8314)
                        });
                });
            ...
            modelBuilder.Entity("OpenAccount.Entities.Requests.InqueryLoan.SamatLoanInquiryRequest", b =>
                {
                    b.HasBaseType("OpenAccount.Entities.Requsts.Request");
            ...
            modelBuilder.Entity("OpenAccount.Entities.Requests.InqueryLoan.SamatLoanInquiryRequestItem", b =>
                {
                    b.HasOne("OpenAccount.Entities.Requests.InqueryLoan.SamatLoanInquiryRequest", null)
                        .WithMany("SamatLoanInquiryRequestItem")
            ...
            modelBuilder.Entity("OpenAccount.Entities.Requests.InqueryLoan.SamatLoanInquiryRequest", b =>
                {
                    b.HasOne("OpenAccount.Entities.Requsts.Request", null)
                        .WithOne()
                        .HasForeignKey("OpenAccount.Entities.Requests.InqueryLoan.SamatLoanInquiryRequest", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("OpenAccount.Entities.Requests.InqueryLoan.SamatLoanInquiryRequest", b =>
                {
                    b.Navigation("SamatLoanInquiryRequestItem");
                });
