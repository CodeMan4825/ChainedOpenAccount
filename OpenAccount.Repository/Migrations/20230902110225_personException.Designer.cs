...
namespace OpenAccount.Repository.Migrations
{
    ...
    [Migration("20230902110225_personException")]
    partial class personException
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OpenAccount.Entities.Accounts.AccountTypeSetting", b =>
                {
                    ...
                    b.Property<long>("CardPrice")
                        .HasColumnType("bigint")
                        .HasComment("هزینه صدور کارت");

                    b.Property<long>("CardSendPrice")
                        .HasColumnType("bigint")
                        .HasComment("هزینه ارسال کارت");

                    b.Property<long>("CardToAccount")
                        .HasColumnType("bigint")
                        .HasComment("کارمزد اتصال کارت به حساب");
                    ...
                    b.Property<byte>("MaxAge")
                        .HasColumnType("tinyint")
                        .HasComment("بیشینه ی زندگی");

                    b.Property<byte>("MinAge")
                        .HasColumnType("tinyint")
                        .HasComment("کمینه ی زندگی");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CardPrice = 36000L,
                            CardSendPrice = 250000L,
                            CardToAccount = 19800L,
                            ...
                            Stamp = 10000,
                            SysDate = new DateTime(2023, 9, 2, 14, 32, 25, 207, DateTimeKind.Local).AddTicks(996)
                        },
                        new
                        {
                            Id = (short)2,
                            ...
                            PostalCodeInquiry = 15000L,
                            Stamp = 10000,
                            SysDate = new DateTime(2023, 9, 2, 14, 32, 25, 207, DateTimeKind.Local).AddTicks(1033)
                        },
                        new
                        {
                            Id = (short)3,
                            ...
                            PostalCodeInquiry = 15000L,
                            Stamp = 10000,
                            SysDate = new DateTime(2023, 9, 2, 14, 32, 25, 207, DateTimeKind.Local).AddTicks(1056)
                        });
                });
            ...
            modelBuilder.Entity("OpenAccount.Entities.Publics.Exceptions.EntityException", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasComment("خطا های مراحل اطلاعات پرسنلی");
                    ...
                    b.ToTable("EntityException", (string)null);
            ...
            modelBuilder.Entity("OpenAccount.Entities.Requests.RequestCard", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasComment("سفارش کارت");

                    b.Property<string>("CardPro")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("OpenAccount.Entities.Publics.Exceptions.InquiryException", b =>
                {
                    ...
                    b.ToTable("InquiryException", (string)null);
                });

            modelBuilder.Entity("OpenAccount.Entities.Publics.Exceptions.PersonException", b =>
                {
                    b.HasBaseType("OpenAccount.Entities.Publics.Exceptions.EntityException");

                    b.Property<byte>("PersonState")
                        .HasColumnType("tinyint");

                    b.Property<string>("PersonStateCaption")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("PersonException", (string)null);
                });
            ...
            modelBuilder.Entity("OpenAccount.Entities.Publics.Exceptions.StartException", b =>
                {
                    ...
                    b.ToTable("StartException", (string)null);
                });
            ...
            modelBuilder.Entity("OpenAccount.Entities.Requests.RequestCard", b =>
                {
                    b.HasOne("OpenAccount.Entities.Requests.Request", "Request")
                        .WithOne("RequestCards")
                        .HasForeignKey("OpenAccount.Entities.Requests.RequestCard", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("OpenAccount.Entities.Publics.Exceptions.InquiryException", b =>
                {
                    b.HasOne("OpenAccount.Entities.Publics.Exceptions.EntityException", null)
                        .WithOne()
                        .HasForeignKey("OpenAccount.Entities.Publics.Exceptions.InquiryException", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("OpenAccount.Entities.Publics.Exceptions.PersonException", b =>
                {
                    b.HasOne("OpenAccount.Entities.Publics.Exceptions.EntityException", null)
                        .WithOne()
                        .HasForeignKey("OpenAccount.Entities.Publics.Exceptions.PersonException", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
