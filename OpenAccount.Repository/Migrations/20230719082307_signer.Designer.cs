...
namespace OpenAccount.Repository.Migrations
{
    ...
    [Migration("20230719082307_signer")]
            ...
            modelBuilder.Entity("OpenAccount.Entities.Accounts.AccountTypeSetting", b =>
                {
                    ...
                    b.Property<long>("OpenAccountPrice")
                        .HasColumnType("bigint")
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            MinBalance = 1000000L,
                            OpenAccountPrice = 40000L,
                            SysDate = new DateTime(2023, 7, 19, 11, 53, 6, 641, DateTimeKind.Local).AddTicks(4936)
                        },
                        new
                        {
                            Id = (short)2,
                            ...
                            MinBalance = 330000L,
                            OpenAccountPrice = 40000L,
                            SysDate = new DateTime(2023, 7, 19, 11, 53, 6, 641, DateTimeKind.Local).AddTicks(4968)
                        });
                });
            ...
            modelBuilder.Entity("OpenAccount.Entities.Requests.RequestDigitalSignature", b =>
                {
                    ...
                    b.Property<string>("Signature")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasComment("گواهی امضاء دیجیتال کاربر");

                    b.Property<string>("SignatureSent")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasComment("گواهی امضاء دیجیتال کاربر ارسال شد");

                    b.Property<string>("SignerCertificate")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasComment("گواهی امضاء جهت ارسال اولیه");

                    b.Property<bool>("SignerCertificateDone")
                        .HasColumnType("bit")
                        .HasComment("گواهی امضاء اولیه دریافت شد؟");

                    b.Property<string>("SignerCertificateResult")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasComment("نتیجه ی گواهی امضاء اولیه");
