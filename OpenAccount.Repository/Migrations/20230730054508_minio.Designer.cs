...
namespace OpenAccount.Repository.Migrations
{
    ...
    [Migration("20230730054508_minio")]
    partial class minio
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OpenAccount.Entities.Accounts.AccountTypeSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Stamp = 10000,
                            SysDate = new DateTime(2023, 7, 30, 9, 15, 7, 946, DateTimeKind.Local).AddTicks(180)
                        },
                        new
                        {
                            Id = (short)2,
                            ...
                            PostalCodeInquiry = 15000L,
                            Stamp = 10000,
                            SysDate = new DateTime(2023, 7, 30, 9, 15, 7, 946, DateTimeKind.Local).AddTicks(215)
                        });
                });
