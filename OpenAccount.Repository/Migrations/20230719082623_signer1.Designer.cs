...
namespace OpenAccount.Repository.Migrations
{
    ...
    [Migration("20230719082623_signer1")]
    partial class signer1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OpenAccount.Entities.Accounts.AccountTypeSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            SysDate = new DateTime(2023, 7, 19, 11, 56, 23, 510, DateTimeKind.Local).AddTicks(9197)
                        },
                        new
                        {
                            Id = (short)2,
                            ...
                            MinBalance = 330000L,
                            OpenAccountPrice = 40000L,
                            SysDate = new DateTime(2023, 7, 19, 11, 56, 23, 510, DateTimeKind.Local).AddTicks(9233)
                        });
                });
