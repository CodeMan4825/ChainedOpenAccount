...
namespace OpenAccount.Repository.Migrations
{
    ...
    [Migration("20230715104822_JobInRealPerson")]
    partial class JobInRealPerson
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OpenAccount.Entities.Accounts.AccountTypeSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            SysDate = new DateTime(2023, 7, 15, 14, 18, 22, 613, DateTimeKind.Local).AddTicks(6815)
                        },
                        new
                        {
                            Id = (short)2,
                            ...
                            MinBalance = 330000L,
                            OpenAccountPrice = 40000L,
                            SysDate = new DateTime(2023, 7, 15, 14, 18, 22, 613, DateTimeKind.Local).AddTicks(6851)
                        });
                });
